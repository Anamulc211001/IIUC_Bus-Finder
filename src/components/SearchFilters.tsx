...
const SearchFilters: React.FC<SearchFiltersProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 p-8 mb-12 -mt-16 relative z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-emerald-100/30 to-transparent rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-4">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium">Find your perfect bus schedule instantly</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {hasActiveFilters && (
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="group bg-red-50 hover:bg-red-100 text-red-600 px-4 py-2 rounded-full font-medium transition-all border border-red-200 hover:border-red-300"
                  >
                    <span className="flex items-center space-x-2">
              ...
              <div className="hidden md:flex items-center space-x-2 text-sm text-gray-500 bg-green-50 px-3 py-2 rounded-full border border-green-200">
          ...
          <div className="mb-8">
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <Search className={`absolute left-6 top-1/2 transform -translate-y-1/2 h-6 w-6 transition-all duration-200 ${
                ...
                <input
                  ...
                  className="w-full pl-16 pr-6 py-5 bg-white/80 backdrop-blur-sm border-2 border-gray-200 rounded-3xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500 text-lg font-medium shadow-lg hover:shadow-xl"
                />
                
                {searchTerm && (
                  <button
                    onClick={() => onSearchChange('')}
                    className="absolute right-6 top-1/2 transform -translate-y-1/2 p-2 text-gray-400 hover:text-red-500 transition-colors rounded-full hover:bg-red-50"
                  >
                    <X className="h-5 w-5" />
                  </button>
                )}
          ...
          <div className="mb-6">
            <button
              ...
              className="group flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 rounded-2xl font-semibold text-gray-700 transition-all border border-gray-200 hover:border-gray-300 shadow-sm hover:shadow-md"
            >
          ...
          <div className={`transition-all duration-500 overflow-hidden ${
            ...
            <div className="bg-gradient-to-br from-gray-50/80 to-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all duration-200 text-gray-900 appearance-none cursor-pointer hover:bg-gray-50 font-medium shadow-sm"
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 text-gray-900 appearance-none cursor-pointer hover:bg-gray-50 font-medium shadow-sm"
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 text-gray-900 appearance-none cursor-pointer hover:bg-gray-50 font-medium shadow-sm"
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-pink-500/20 focus:border-pink-500 transition-all duration-200 text-gray-900 appearance-none cursor-pointer hover:bg-gray-50 font-medium shadow-sm"
                    >
                ...
                <div className={`space-y-3 ${scheduleType !== 'Friday' ? 'opacity-50' : ''}`}>
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-gray-900 appearance-none cursor-pointer hover:bg-gray-50 disabled:cursor-not-allowed disabled:bg-gray-100 font-medium shadow-sm"
                    >
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {routeFilter !== 'All' && (
              <div className="p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border border-emerald-200 shadow-sm">
                <div className="flex items-center space-x-2 mb-1">
