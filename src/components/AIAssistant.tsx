...
const AIAssistant: React.FC<AIAssistantProps> = ({ schedules }) => {
  ...
  return (
    <>
      {/* Chat Widget Button - Positioned on left side to avoid conflicts */}
      ...
      {/* Chat Window - Full screen on mobile, properly positioned on desktop */}
      {isOpen && (
        <>
          ...
          {/* Chat Container */}
          <div className="fixed inset-4 sm:inset-auto sm:left-20 sm:top-1/2 sm:transform sm:-translate-y-1/2 sm:w-80 lg:w-96 sm:h-[500px] lg:h-[600px] sm:max-h-[90vh] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden animate-fade-slide-up">
