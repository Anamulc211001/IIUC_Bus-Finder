    ...
    <>
      ...
      <div className="fixed right-4 sm:right-6 top-1/2 transform -translate-y-1/2 z-50">
        ...
        >
          {/* Notification Badge */}
          {!isOpen && (
            <div className="absolute -top-2 -left-2 w-5 h-5 sm:w-6 sm:h-6 bg-red-500 rounded-full flex items-center justify-center text-xs font-bold animate-bounce">
      ...
      {/* Chat Window - Properly positioned with responsive design */}
      {isOpen && (
        <div className="fixed inset-4 sm:right-20 sm:top-1/2 sm:transform sm:-translate-y-1/2 sm:left-auto sm:bottom-auto sm:w-80 lg:w-96 sm:h-[500px] lg:h-[600px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden animate-fade-slide-up">
          ...
          <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-600 text-white p-4 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-bold text-base sm:text-lg">IIUC Bus Assistant</h3>
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-gray-50">
            {messages.map((message) => (
              <div key={message.id} className={`flex ${message.isBot ? 'justify-start' : 'justify-end'}`}>
                <div className={`max-w-[85%] sm:max-w-xs lg:max-w-sm px-3 sm:px-4 py-2 sm:py-3 rounded-2xl ${
                  message.isBot 
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-xs sm:text-sm"
                  disabled={isTyping}
                />
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:from-gray-300 disabled:to-gray-400 text-white p-2 sm:p-3 rounded-2xl transition-all shadow-lg hover:shadow-xl disabled:cursor-not-allowed"
              >
